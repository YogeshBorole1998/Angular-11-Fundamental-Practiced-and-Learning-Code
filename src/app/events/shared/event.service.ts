...
import { IEvent, Session } from './event.model';
...
export class EventService {
  ...
  /**
   * find method may return undefined if the specified id is not found in the EVENTS array. To address this issue,
   * you can modify the getEvent function to explicitly handle the case where find returns undefined.
   * One way to do this is to use the non-null assertion operator (!) to tell TypeScript that you are certain the result is not undefined.
   */
...
const EVENTS: IEvent[] = [
  ...
  {
    id: 3,
    name: 'National Devops Conf 2037',
  ...
  {
    id: 5,
    name: 'AWS Implementation using AI',
